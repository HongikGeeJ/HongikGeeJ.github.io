...
assets = {
    ...
    'assets/dancheong/edge-sparkles.svg?v=sea2': root / 'assets/dancheong/edge-sparkles.svg',
    'assets/dancheong/edge-sparkles-static.svg?v=sea2': root / 'assets/dancheong/edge-sparkles-static.svg',
